...
export function NewPatientOfferFloat() {
  ...
  return (
    <Link
      ...
      aria-label={onOfferPage ? "Book my $49 First Visit" : "See the $49 First Move Session offer"}
    ...
    >
      <span className="flex flex-col gap-1 text-left">
        ...
        <span className="text-sm font-semibold tracking-wide">{onOfferPage ? "Book My $49 First Visit" : "$49 First Move Session"} <span aria-hidden="true" className="inline-block transition-transform duration-200 group-hover:translate-x-1">→</span></span>
      </span>
    </Link>
  );
}
