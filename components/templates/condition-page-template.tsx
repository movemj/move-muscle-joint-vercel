    ...
    <>
      ...
      <section className="flex min-h-[calc(100svh-5rem)] items-center bg-charcoal py-28 sm:min-h-[calc(100vh-5rem)] sm:py-16">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          />
          <p className="mt-4 text-xs text-white/55">Reviewed by <Link href="/about" className="underline underline-offset-2 hover:text-white/80">Joseph Hugunin, DC — 20+ years of clinical experience, former team chiropractor for Sporting Kansas City</Link></p>
          <motion.h1
