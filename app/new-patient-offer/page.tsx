...
export default function NewPatientOfferPage() {
  return (
    <main className="bg-white pb-28 md:pb-0">
      ...
      <section className="bg-light-gray py-20 text-charcoal sm:py-28">
        <div className="mx-auto grid max-w-7xl gap-12 px-6 sm:px-8 lg:grid-cols-[0.7fr_1.3fr] lg:items-center lg:gap-24 lg:px-16">
          <div className="lg:border-l lg:border-navy/15 lg:pl-10"><p className="text-xs font-bold uppercase tracking-[0.2em] text-accent">New patient offer</p><p className="mt-3 text-8xl font-bold leading-none tracking-[-0.07em] text-navy sm:text-9xl">$49</p><p className="mt-3 text-sm font-semibold uppercase tracking-[0.2em] text-navy/70">First Move Session</p><p className="mt-6 max-w-sm text-lg leading-relaxed text-steel">No guessing. No generic protocol. Start with clarity.</p></div>
