...
export function OurApproachContent() {
  return (
    <>
      <HeroMedia imageSrc={IMAGES.assessment} alt="Clinician guiding a patient through movement treatment at Move Muscle & Joint in Overland Park" overlayOpacity="bg-charcoal/60" imageClassName="scale-110">
